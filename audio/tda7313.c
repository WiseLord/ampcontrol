...
void loadAudioParams(uint8_t **txtLabels)
{
    ...
    sndPar[SND_FRONTREAR].value = eeprom_read_byte((uint8_t *)MODE_SND_FRONTREAR);
    ...
    loud = eeprom_read_byte((uint8_t *)EEPROM_APROC_EXTRA);
...
void saveAudioParams(void)
{
    ...
    eeprom_update_byte((uint8_t *)EEPROM_APROC_EXTRA, loud);
